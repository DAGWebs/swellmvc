...
<body class="hold-transition login-page" style="background: #222;">
<div class="login-box">
  <div class="login-logo">
    <a href="vendor/adminLTE/index2.html"><b><?=APP_NAME?></b> | Login</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form action="/login/submit" method="post">
        ...
        <div class="row">
          ...
          <!-- /.col -->
          <div class="col-4">
            <button type="submit" class="btn btn-primary btn-block" name="login_action">Sign In</button>
          </div>
          <!-- /.col -->
        </div>
      </form>
